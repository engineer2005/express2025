...
const PreviousEvents: React.FC = () => {
  ...
  const events: Event[] = [
    ...
    },
    {
      ...
      images: [
        { src: m1, alt: "Aryavarta 3.0 - 1" },
        { src: m2, alt: "Aryavarta 3.0 - 2" },
        { src: o1, alt: "Aryavarta 3.0 - 3" }
      ]
    },
    {
    ...
    },
    {
      ...
      images: [
        { src: j2, alt: "Aryavarta 2.0 - 1" },
        { src: m2, alt: "Aryavarta 2.0 - 2" },
        { src: o1, alt: "Aryavarta 2.0 - 3" }
      ]
    },
    {
      title: "Aryavarta 1.0",
